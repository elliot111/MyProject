...
public class FlexboxLayoutManagerActivity extends BaseActivity {
    ...
    private PubushiAdapter mAdapter;
    private List<ShishiOrderListBean.ListBean> list=new ArrayList<>();

    @Override
    protected int initLayoutInflater() {
        return R.layout.activity_flexbox_layout_manager;
    }
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PubushiAdapter(FlexboxLayoutManagerActivity.this,list);
        FlexboxLayoutManager manager = new FlexboxLayoutManager(FlexboxLayoutManagerActivity.this, FlexDirection.ROW);
        //设置是否换行
